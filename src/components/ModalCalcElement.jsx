...
const ModalCalcElement = ({setIsActiveCalc, completed, setCompleted, setIsActive}) => {
   ...
   const getContainerWidth = () => {
      ...
      if(screenWidth.isScreenMd) containerWidth = 200*2+50
      if(screenWidth.isScreenLg) containerWidth = 200*3+110
      if(screenWidth.isScreenXl) containerWidth = 317*3+110
   ...
   const handleRightArrowClick = () => {
      ...
      setOffset((currentOffset) => {
         const newOffset = currentOffset - CONTAINER_WIDTH 
         const maxOffset = -(CONTAINER_WIDTH * (MAX_PAGES-1))
